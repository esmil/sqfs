...
use super::SQUASHFS_FILE_MAX_LOG;
...
use super::SQUASHFS_LDIR_TYPE;
use super::SQUASHFS_LREG_TYPE;
use super::SQUASHFS_LSYMLINK_TYPE;
use super::SQUASHFS_LBLKDEV_TYPE;
use super::SQUASHFS_LCHRDEV_TYPE;
use super::SQUASHFS_LFIFO_TYPE;
use super::SQUASHFS_LSOCKET_TYPE;

// flags
use super::SQUASHFS_NOI;
use super::SQUASHFS_NOD;
use super::SQUASHFS_CHECK;
use super::SQUASHFS_NOF;
use super::SQUASHFS_NO_FRAG;
use super::SQUASHFS_ALWAYS_FRAG;
use super::SQUASHFS_DUPLICATE;
use super::SQUASHFS_EXPORT;
use super::SQUASHFS_NOX;
use super::SQUASHFS_NO_XATTR;
use super::SQUASHFS_COMP_OPT;
